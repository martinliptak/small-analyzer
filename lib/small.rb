module Small
	...
	autoload :SyntaxAnalyzerRemainingError, File.expand_path('small/syntax_analyzer', File.dirname(__FILE__))
	autoload :SyntaxAnalyzerUnknownError, File.expand_path('small/syntax_analyzer', File.dirname(__FILE__))
	autoload :SyntaxAnalyzerUnexpectedError, File.expand_path('small/syntax_analyzer', File.dirname(__FILE__))
end